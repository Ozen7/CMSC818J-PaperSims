...
class MatrixAFetcher:
    def __init__(self,A) -> None:
        ...
        # Code counting the number of values in each column goes here!
    ...
    def cycle():
        ...
        # 2) If it does, load them into the FIFO
...
class PartialMatrixFetcher:
    def __init__(self) -> None:
        pass
    
    
class PartialMatrixWriter:
    # Basically just a buffer after the merge tree
    def __init__(self) -> None:
        pass
